...
" {{{ General colors
hi Normal   ctermfg=235 ctermbg=15  guifg=#000000   guibg=#FFFFFF
...
hi LineNr   ctermfg=249 ctermbg=15 guifg=#959595 guibg=#ECECEC gui=bold cterm=none
"hi CursorLine ctermfg=0 ctermbg=15 guifg=#000000   guibg=#FFFFFF cterm=none gui=none
"hi CursorLineNr ctermfg=0  ctermbg=15 guifg=#000000   guibg=#FFFFFF cterm=bold
...
hi PreProc  ctermfg=209 guifg=#A0A0A0 gui=bold cterm=bold
hi Comment  ctermfg=245 guifg=#999988
hi Constant ctermfg=26 guifg=#177F80 gui=none cterm=none
hi String   ctermfg=244 guifg=#D81745
hi Function ctermfg=97 guifg=#990000 gui=bold cterm=bold
hi Statement    ctermfg=0 guifg=#000000 gui=bold cterm=bold
hi Type     ctermfg=0  guifg=#000000 gui=bold   cterm=bold
