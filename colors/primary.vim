...
exe 'hi String       '.s:M.'bg='.s:BG  .' '.s:M.'fg='.s:PURPER  .' '.s:M.'='.s:I
...
exe 'hi Comment      '.s:M.'bg='.s:BG  .' '.s:M.'fg='.s:DGREY.' '.s:M.'=none'
...
exe 'hi Number       '.s:M.'bg='.s:BG  .' '.s:M.'fg='.s:ORANGE.' '.s:M.'=none'
exe 'hi Float        '.s:M.'bg='.s:BG  .' '.s:M.'fg='.s:ORANGE.' '.s:M.'=none'
...
exe 'hi Type         '.s:M.'bg='.s:BG .' '.s:M.'fg='.s:ORANGE.' '.s:M.'=bold'
exe 'hi StorageClass '.s:M.'bg='.s:BG .' '.s:M.'fg='.s:DBLUE.' '.s:M.'=bold'
exe 'hi Structure    '.s:M.'bg='.s:BG .' '.s:M.'fg='.s:DBLUE.' '.s:M.'=bold'
...
exe 'hi Search       '.s:M.'bg='.s:GREEN.' '.s:M.'fg='.s:BG  .' '.s:M.'=none'
...
if (has('gui_running') || &t_Co == 256)
  ...
  exe 'hi Linenr       '.s:M.'bg='.s:WHITE.' '.s:M.'fg='.s:BLACK.' '.s:M.'=none'
